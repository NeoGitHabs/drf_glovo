...
class ComboViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Combo.objects.filter(store__owner_store=self.request.user)
...
class CartViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Cart.objects.filter(cart_owner=self.request.user)
...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Order.objects.filter(client_profile=self.request.user)
...
class CourierRatingViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return CourierRating.objects.filter(client_profile=self.request.user)